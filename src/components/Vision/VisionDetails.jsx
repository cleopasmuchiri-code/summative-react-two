...
const VisionDetails = () => {
  ...
  const { visions, contributions, users, deleteVision } = useApp();
          ...
          <div>
            <div className="flex justify-between">
              ...
              <button
                ...
                className="text-center text-white cursor-pointer flex justify-center items-center gap-3 bg-red-500 hover:bg-red-900 px-3 py-1 rounded-full"
              >
                <p>
                  <Trash />
                </p>
          ...
          {addCustomContribution && (
            <div className="fixed inset-0 z-10 grid place-items-center h-screen w-screen bg-white/10 ">
              <div
                ...
                className="absolute inset-0 w-full h-full  bg-primary/30"
              ></div>
              <ContributionForm
